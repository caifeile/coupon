...
import com.dream.coupon.account.AccountActivity;
import com.dream.coupon.activity.LoginActivity;
import com.dream.coupon.channel.ChannelActivity;
import com.dream.coupon.home.HomeActivity;
import com.dream.coupon.more.MoreActivity;
...
public class MainActivity extends TabActivity implements OnClickListener {
	...
	ImageView mBut1, mBut2, mBut4, mBut5;
	TextView mCateText1, mCateText2, mCateText4, mCateText5;

	Intent mHomeItent, mChannelIntent, mAccountIntent,
			mMoreIntent;
...
//				R.drawable.icon_3_n, mSearchIntent));
	...
	public void onClick(View v) {
		...
		if (mCurTabId == vid) {
			return;
		}else if(R.id.channel4 == vid && DataShare.currentUser.getId() == 0){
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch(resultCode){
		case DataShare.RESULT_LOGIN_SUCCESS:
			mBut1.setImageResource(R.drawable.icon_1_n);
			mBut2.setImageResource(R.drawable.icon_2_n);
			mBut4.setImageResource(R.drawable.icon_4_n);
			mBut5.setImageResource(R.drawable.icon_5_n);
